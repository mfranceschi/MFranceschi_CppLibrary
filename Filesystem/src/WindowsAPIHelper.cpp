...
// ///////////////////////////////////////////////////////////////
    ...
    File::Filesize_t Windows_GetFileSize(File::Filename_t filename) {
        HANDLE file = CreateFile(filename, GENERIC_READ, FILE_SHARE_READ, nullptr, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL,
                                 nullptr);
    ...
    void Windows_GetDirectoryContents(File::Filename_t directoryName, std::vector<File::SFilename_t> &result) {
        ...
        if (hFind != INVALID_HANDLE_VALUE) {
            do {
                ...
                if ((wfd.dwFileAttributes == INVALID_FILE_ATTRIBUTES) ? false : (wfd.dwFileAttributes &
    ...
    int Windows_ReadFileToBuffer(File::Filename_t filename, char *buffer, File::Filesize_t bufferSize) {
        Windows_FileHandle fileHandle = CreateFile(filename, GENERIC_READ, FILE_SHARE_READ, nullptr, OPEN_EXISTING,
                                                   FILE_ATTRIBUTE_NORMAL, nullptr);
