...
TEST(String_ToUpperCase, itWorks) {
    EXPECT_EQ(toUpperCase(std::string("e")), std::string("E"));
}

TEST(String_ToLowerCase, itWorks) {
    EXPECT_EQ(toLowerCase(std::string("E")), std::string("e"));
}
