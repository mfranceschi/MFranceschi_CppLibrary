...
namespace MF
{
    namespace Command
    {
        ...
        struct CommandCall {
            Filename_t executable; // Name or path to the executable
            std::vector<Filename_t> arguments; // List of arguments to the executable, they will be
                                               // concatenated with " ".
            Filename_t outputFile; // [?] File in which to write outputs
            OutputChoice outputChoice = OutputChoice::KEEP; // Choice for outputs
            Filename_t errorFile; // [?] File in which to write errors
            ErrorChoice errorChoice = ErrorChoice::KEEP; // Choice for errors
            Filename_t inputString; // [?] String as input
            Filename_t inputFile; // [?] File as input
